...
const stepActions: UIAction[][] = [
  [
    ...
    {
      kind: 'show_toast',
      message: '모바일 앱으로 인증 푸시 발송 요청',
      tone: 'info',
      description:
        '서버가 푸시 서버로 정대리 법인폰에 인증 푸시를 발송합니다.',
    },
  ],
  [
    {
      ...
      ctaLabel: '인증하기',
      description: '법인폰에 푸시 카드가 도착합니다.',
    },
    {
      kind: 'show_toast',
      message: '모바일 생체 인증 진행 — 지문 인식',
      tone: 'info',
      description: '정대리가 푸시를 탭하면 생체 인증 다이얼로그가 표시됩니다.',
    },
    {
      kind: 'show_toast',
      message: '인증 결과 서버 저장 (승인)',
      tone: 'success',
      description:
        '생체 인증 성공 후 결과가 서버에 저장됩니다.',
    },
  ],
  [
    {
      ...
      tone: 'info',
      description:
        'PC 는 주기 조회로 인증 결과를 받아 로그인 버튼이 활성화됩니다.',
    },
    {
      kind: 'show_toast',
...
const stepDescriptions = [
  '정대리가 PC SalesBridge 에서 사번 입력 후 "모바일 앱으로 인증하기" 를 눌러 푸시를 발송합니다.',
  '법인폰에 푸시가 도착해 생체 인증으로 본인 확인을 진행합니다.',
  'PC 가 주기 조회로 인증 결과를 받아 로그인을 완성합니다.',
];
